export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-5 text-center">
      ...
      <h2 className="mt-4 font-display text-2xl font-bold text-foreground">Halaman tidak ditemukan / Page not found</h2>
      <p className="mt-4 max-w-md text-muted-foreground">
        Maaf, halaman yang Anda cari tidak tersedia atau telah dipindahkan. / Sorry, the page you are looking for is not available.
      </p>
      <a
        href="/id"
